...
import { TOOLS, CATEGORIES, STATS, STEPS, FEATURES, FAQS, ICON_TILE } from '../mock';
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0d16] text-slate-900 dark:text-slate-100 transition-colors">
      ...
      {/* FAQ — directly below the tools grid, answers in HTML format */}
      <section id="faq" className="max-w-3xl mx-auto px-4 sm:px-6 pt-4 pb-16 sm:pt-8 sm:pb-20 scroll-mt-20" data-testid="faq-section">
        <div className="text-center mb-10">
          <span className="text-xs font-bold uppercase tracking-widest text-rose-500">Got questions?</span>
          <h2 className="font-display font-bold text-3xl sm:text-4xl mt-3">Frequently asked questions</h2>
          <p className="text-slate-500 dark:text-slate-400 mt-3">Everything you need to know about using LovePDF.</p>
        </div>
